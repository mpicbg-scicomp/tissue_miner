...
If you like to try Tissue Miner for the **first time**, please download the Demo sample that contains images of segmented and tracked cells pre-processed in TissueAnalyzer.

## 0. Open a terminal

### 0.1 Mac and Windows: open a "Docker Quick Start Terminal"
Once you have installed [Docker](https://docs.docker.com/mac/step_one/), open a Finder window, go to the Applications/Docker folder, and click "Docker Quickstart Terminal".

### 0.2 Ubuntu: just open a [terminal](https://help.ubuntu.com/community/UsingTheTerminal)


## 1. Download some example data (~100mb)
```
...
## 2. Example for a cell area analysis
