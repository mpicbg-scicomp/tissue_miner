...
You'd like to try Tissue Miner for the **first time** ? Please follow the prodecure below to try it on a small Demo sample that contains images of segmented and tracked cells (pre-processed in TissueAnalyzer).


## 1. Open a terminal

* Mac and Windows: open a "Docker Quick Start Terminal". 
