---
title: "TissueMiner User Manual for TM_1.0.1"
...
### Start and access the RStudio server 

Here, we describe the API requirements on the Docker plateform. Please note that if you are not using the Docker plateform, the TissueMiner API has already been installed and configured during the installation procedure of TissueMiner, you would just need to install an integrated environment for R programming (such as RStudio).

***

**On any operating systems with the Docker plateform**, you can use the **Rstudio server** from the provided docker image that includes all necessary R packages and dependencies. 


* **Step1: Create a RStudio-server container**
...
### Stop, start, remove the RStudio-server container
...
## Your first script: load the TissueMiner API in R
