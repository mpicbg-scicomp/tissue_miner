...
* Next, you can download/update the TissueMiner application bundled in a docker image called _etournay/tissue_miner_ (~700Mb). On Mac or Windows, open a Docker Quick Start Terminal and type in:
